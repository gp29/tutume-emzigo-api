        ...
        try {
            ...
            if(requestParam.text && requestParam.text !=''){
                columnAndValue['$or'] = [{
                    ...
                    "catDetails.name": new RegExp(requestParam.text, 'i')
                }, {
...
const create = async(requestParam) => {
    return new Promise(async(resolve, reject) => {
        try {
            let response = await query.selectWithAndOne(dbConstants.dbSchema.products, {product_category_id: requestParam.product_category_id, name: requestParam.name}, { _id: 0, product_id:1}, { created_at: 1 });
            if(response){
    ...
    return new Promise(async(resolve, reject) => {
        try {
            let compareColumnAndValues = {
                ...
                product_category_id: requestParam.product_category_id, 
