...
const cmsHandler = require('./../model_handlers/cms-handler');

router.post('/create', async(req, res) => {
    try {
        let response = await cmsHandler.create(req.body);
...
router.post('/get-sort', async(req, res) => {
    try {
        let response = await cmsHandler.getSort(req.body);
        jsonResponse(res, responseCodes.OK, null, response);
    } catch (error) {
        jsonResponse(res, error.code, error, null);
    }
...
router.get('/get', async(req, res) => {
    try {
        let response = await cmsHandler.get(req.query);
        jsonResponse(res, responseCodes.OK, null, response);
    } catch (error) {
        jsonResponse(res, error.code, error, null);
    }
...
router.post('/action', async(req, res) => {
    try {
        let response = await cmsHandler.action(req.body);
        jsonResponse(res, responseCodes.OK, null, response);
    } catch (error) {
        jsonResponse(res, error.code, error, null);
    }
...
router.post('/update', async(req, res) => {
    try {
        let response = await cmsHandler.update(req.body);
        jsonResponse(res, responseCodes.OK, null, response);
    } catch (error) {
        jsonResponse(res, error.code, error, null);
    }
...
router.get('/list', async(req, res) => {
    try {
        ...
        let response = await cmsHandler.list(req.query);
